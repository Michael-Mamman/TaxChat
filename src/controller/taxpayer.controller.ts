...
export const updateTaxpayer = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const taxpayer = await Taxpayer.findOneAndUpdate(
      { phone },
      { $set: updates },
...
export const listTaxpayers = async (req: Request, res: Response) => {
