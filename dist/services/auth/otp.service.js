...
import { OTP_EXPIRY_SECONDS, MAX_OTP_ATTEMPTS, OTP_DELIVERY_CHANNEL, SMS_GATEWAY_URL, } from "../../config.js";
...
class OTPService {
    ...
    async sendOTP(phone, purpose = "auth") {
        ...
        if (OTP_DELIVERY_CHANNEL === "whatsapp") {
            ...
            await whatsappService.sendMessage(phone, `Your NRS TaxChat verification code is *${code}*.\n\n` +
    ...
    async verifyOTP(phone, code) {
        ...
        if (otp.attempts >= MAX_OTP_ATTEMPTS) {
            ...
            return {
                valid: false,
                message: "Maximum attempts exceeded. Your account is locked for 30 minutes. Please try again later or type AGENT for help.",
                locked: true,
            };
        }
        otp.attempts += 1;
