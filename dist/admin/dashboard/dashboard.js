...
const Dashboard = () => {
    ...
    return (_jsxs(Box, { variant: "grey", children: [_jsxs(Box, { mb: "xxl", style: { display: "flex", alignItems: "center", gap: "16px" }, children: [_jsx(Logo, { width: 54, variant: "mark" }), _jsxs(Box, { children: [_jsx(H2, { color: "text", style: { margin: 0, lineHeight: 1.2 }, children: "Overview" }), _jsx(Text, { color: "grey60", style: { fontSize: "14px" }, children: "Virtual Tax Office \u2014 Nigeria Revenue Service" })] })] }), error ? _jsx(Text, { color: "grey60", children: error }) : null, !stats && !error ? _jsx(Loader, {}) : null, stats ? (_jsxs(_Fragment, { children: [_jsx(Box, { style: grid(240), children: buildCards(stats).map((c) => (_jsx(StatCard, { ...c }, c.label))) }), _jsx(Box, { mt: "xl", children: _jsx(Panel, { title: "Activity", subtitle: activitySubtitle(stats), children: _jsx(AreaChart, { data: stats.activityByDay }) }) }), _jsxs(Box, { mt: "xl", style: grid(420), children: [_jsx(Panel, { title: "Service requests by status", subtitle: "All requests on record", children: _jsx(BarChart, { data: stats.requestsByStatus }) }), _jsx(Panel, { title: "Taxpayers by authentication tier", subtitle: "Tier 0 unauthenticated \u2192 Tier 3 full KYC", children: _jsx(BarChart, { data: stats.taxpayersByTier, ordinal: true }) }), _jsx(Panel, { title: "Notifications by delivery status", subtitle: "All notifications on record", children: _jsx(BarChart, { data: stats.notificationsByStatus }) })] }), _jsx(Box, { mt: "xl", mb: "xl", children: _jsx(Panel, { title: "Recent service requests", subtitle: "Most recently raised", children: _jsx(RecentTable, { rows: stats.recentRequests }) }) })] })) : null] }));
};
